...
$apiUrl = 'https://localhost:54323/api/'; // Base URL for Mautic API
$username = 'admin'; // Replace with your Mautic username
$password = 'Maut1cR0cks!'; // Replace with your Mautic password

// Initialize Mautic API
$mautic = new MauticAPI($apiUrl, $username, $password);

echo "<h2>Mautic API Operations</h2><br>"; // Debugging line
